...
Route::put('/member-accept/{id}', [MemberController::class, 'accept'])->name('member.accept');
Route::put('/member-reject/{id}', [MemberController::class, 'reject'])->name('member.reject');
